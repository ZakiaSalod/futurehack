...
import online.weoutchea.pip.config.audit.AuditEventConverter;
import online.weoutchea.pip.domain.PersistentAuditEvent;
...
import static online.weoutchea.pip.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
